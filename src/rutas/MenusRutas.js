...
// Función para validar tipo de contacto
function validarTipoContacto(tipoContacto) {
    return tiposContactoValidos.hasOwnProperty(tipoContacto);
}
...
module.exports = function () {
    ...
    router.post('/', (req, res) => {
        ...
        if (!validarTipoContacto(contactoData.Tipo_Contacto)) {
